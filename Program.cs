...
using (var scope = app.Services.CreateScope())
{
    ...
    catch (Exception ex)
    {
        ...
        logger.LogWarning(ex, "Não foi possível aplicar migrations/seed do banco de dados. A aplicação continuará rodando, mas funcionalidades que dependem do banco não funcionarão até o banco ser configurado.");
    }
}
